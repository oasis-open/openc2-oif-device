...
def allow(self, cmd_id=0, action='allow', target={}, args={}, actuator={}, *extra_args, **extra_kwargs):
    """
    Base function for the Allow Action
    :param self: instance of the actuator that has called this function - object
    :param cmd_id: id of the command
    :param action: action of the command - allow
