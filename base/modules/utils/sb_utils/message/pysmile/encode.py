...
class SmileGenerator(object):
    ...
    def write_number(self, i):
        ...
        if isinstance(i, int):
            ...
            if isinstance(i, decimal.Decimal) and isinstance(int(float(i)), int):
    ...
    def write_byte(self, c):
        ...
        c = bytes(c, 'utf-8') if isinstance(c, str) else c
